...
module.exports = {
  ...
  prompts: [
    {
      type: 'input',
      name: 'name',
      message: 'What should it be called? Please use PascalCase',
  ...
  actions: (data) => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../../src/components/{{kebabCase name}}/tests/{{kebabCase name}}.test.js',
    ...
    if (data.wantMessages) {
      actions.push({
        type: 'add',
        path: '../../src/components/{{kebabCase name}}/messages.js',
